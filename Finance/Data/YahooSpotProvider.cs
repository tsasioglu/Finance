...
{
    public interface IYahooSpotProvider
    {
        ExchangeRate[] GetAllSpotRate();
        ExchangeRate   GetSpotRate(string currencyPair);
    }

    public class YahooSpotProvider : IYahooSpotProvider
    {
        private readonly IYahooStreamProvider _yahooStreamProvider;
        
        public YahooSpotProvider(IYahooStreamProvider yahooStreamProvider)
        {
    ...
    public interface IYahooStreamProvider
    {
        Stream GetStream(string currencyPair);
    }

    public class YahooStreamProvider : IYahooStreamProvider
    {
